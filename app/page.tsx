  ...
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            ...
            },
            {
              ...
              <div key={i} className="proof-artifact p-8 flex flex-col group">
                <div className="artifact-header">PROOF OBJECT {String(i+1).padStart(2,'0')}</div>
      ...
      <section className="section max-w-4xl mx-auto px-6 text-center">
        <p className="text-[#C5BBAE] italic">
          “Cream paper. Aerospace navy. Gold signal lines. WonderCards. Badges. Blueprint traces. Child imagination, adult-grade structure.”
        </p>
        <p className="mt-2 text-sm">— The BYDT Visual Operating System</p>
      </section>
      ...
      <section className="section max-w-6xl mx-auto px-6">
        <div className="text-center mb-12">
          <div className="uppercase tracking-[3px] text-xs text-gold font-mono mb-2 gold-signal">WHO IT&apos;S FOR</div>
      ...
      <section className="section bg-surface border-y border-border">
        <div className="max-w-4xl mx-auto px-6 flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="flex-1 w-full aspect-[4/3] blueprint bg-[#F8F4ED] rounded-2xl flex items-center justify-center border border-border">
